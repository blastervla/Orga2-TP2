...
global Bordes_asm
global Bordes_asm_twice_unrolled
global Bordes_asm_four_times_unrolled
global Bordes_asm_eight_times_unrolled
...
Bordes_asm_four_times_unrolled:
...
Bordes_asm_eight_times_unrolled:
